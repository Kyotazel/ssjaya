        ...
        <header class="topbar" data-navbarbg="skin6">
            <nav class="navbar top-navbar navbar-expand-md">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    ...
                    <a href="<?= base_url('sales/login/logout') ?>" class="text-dark"><i data-feather="log-out" class="feather-icon"></i> Logout</a>
                </div>
            </nav>
        </header>
        <!-- ============================================================== -->
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="d-flex align-items-center">
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-0">Selamat datang <?= $this->session->userdata('sales_name') ?></h4>
                    <div class="ml-auto">
